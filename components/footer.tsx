...
function Collaboration() {
  return (
    <Box id="footer" sx={{ backgroundColor: 'black', color: 'white', minHeight: '100vh', padding: { xs: '1rem', sm: '2rem' }, position: 'relative' }}>
      <Container sx={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <Box sx={{ marginTop: '2rem' }}>
          <Button href="mailto:moraar976@gmail.com" variant="contained" sx={{ backgroundColor: 'brown', color: 'black', marginRight: '1rem' }}>Get in Touch</Button>
          <Button href="https://www.linkedin.com/in/ruth-moraa-5666a5233/" variant="outlined" sx={{ borderColor: 'white', color: 'white' }}>Hire Me Now</Button>
        </Box>
      </Container>
